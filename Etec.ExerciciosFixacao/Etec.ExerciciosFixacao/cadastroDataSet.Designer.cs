...
namespace Etec.ExerciciosFixacao {
    ...
    public partial class cadastroDataSet : global::System.Data.DataSet {
        ...
        public partial class ClientesDataTable : global::System.Data.TypedTableBase<ClientesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public ClientesRow AddClientesRow(string Nome, string Endereco, string RG, string CPF, string Cidade, string Estado, decimal Salario) {
        ...
        public partial class ClientesRow : global::System.Data.DataRow {
            ...
            public decimal Salario {
                get {
                    try {
                        return ((decimal)(this[this.tableClientes.SalarioColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'Salario\' in table \'Clientes\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tableClientes.SalarioColumn] = value;
                }
            }
            ...
            public bool IsSalarioNull() {
                return this.IsNull(this.tableClientes.SalarioColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public void SetSalarioNull() {
                this[this.tableClientes.SalarioColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace Etec.ExerciciosFixacao.cadastroDataSetTableAdapters {
    ...
    public partial class ClientesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM `Clientes` WHERE ((`Id` = ?) AND ((? = 1 AND `Nome` IS NULL) OR (`Nome` = ?)) AND ((? = 1 AND `Endereco` IS NULL) OR (`Endereco` = ?)) AND ((? = 1 AND `RG` IS NULL) OR (`RG` = ?)) AND ((? = 1 AND `CPF` IS NULL) OR (`CPF` = ?)) AND ((? = 1 AND `Cidade` IS NULL) OR (`Cidade` = ?)) AND ((? = 1 AND `Estado` IS NULL) OR (`Estado` = ?)) AND ((? = 1 AND `Salario` IS NULL) OR (`Salario` = ?)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `Clientes` (`Nome`, `Endereco`, `RG`, `CPF`, `Cidade`, `Estado`, `Sal" +
                "ario`) VALUES (?, ?, ?, ?, ?, ?, ?)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Etec.ExerciciosFixacao.Properties.Settings.Default.cadastroConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Nome, Endereco, RG, CPF, Cidade, Estado, Salario FROM Clientes";
        ...
        public virtual int Delete(int Original_Id, string Original_Nome, string Original_Endereco, string Original_RG, string Original_CPF, string Original_Cidade, string Original_Estado, global::System.Nullable<decimal> Original_Salario) {
        ...
        public virtual int Insert(string Nome, string Endereco, string RG, string CPF, string Cidade, string Estado, global::System.Nullable<decimal> Salario) {
            if ((Nome == null)) {
        ...
        public virtual int Update(string Nome, string Endereco, string RG, string CPF, string Cidade, string Estado, global::System.Nullable<decimal> Salario, int Original_Id, string Original_Nome, string Original_Endereco, string Original_RG, string Original_CPF, string Original_Cidade, string Original_Estado, global::System.Nullable<decimal> Original_Salario) {
            if ((Nome == null)) {
